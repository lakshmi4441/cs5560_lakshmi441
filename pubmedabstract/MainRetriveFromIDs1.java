...
//	        	{
	           // URL url = new URL("http://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?db=pubmed&term=science%5bjournal%5d+AND+cancer+AND+"+i+"%5bpdat%5d");
	        		  URL url = new URL("https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?db=pubmed&term=breast%20cancer%20disease&retmax=10");
	           ...
	           String d;
	           File f = new File("new_data_alzimer//ids.xml");
